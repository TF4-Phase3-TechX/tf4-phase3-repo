...
Tài liệu này chi tiết hóa quyền hạn của Permission Set `TF4-SecReliabilityReadOnlyAudit`. Đây là tập hợp quyền phục vụ công tác giám sát bảo mật hạ tầng chuyên sâu và đánh giá độ tin cậy của toàn bộ hệ thống dự án TF4.
