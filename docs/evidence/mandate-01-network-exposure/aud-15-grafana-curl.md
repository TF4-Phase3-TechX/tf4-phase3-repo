# AUD-15 — Grafana public access test
...
curl -sS -D - -o /dev/null "$ALB/grafana/"
```
...
**Trạng thái:** ✅ PASS
Grafana đã bị chặn truy cập từ Public Internet (trả về mã lỗi 404), đúng theo yêu cầu của Mandate 01 về việc giới hạn các cổng vận hành nội bộ.
