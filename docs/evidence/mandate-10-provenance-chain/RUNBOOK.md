...
```text
S1-00-cluster-context.png
S1-01-pod-runtime-image-digest.png
S1-02-ecr-digest-match.png
S1-03-cosign-signature-verification.png
S1-04-provenance-attestation-sbom.png
```
