# Evaluation Run Evidence — `2026-07-22-00-52-10-8317`

> **Timestamp (UTC)**: `2026-07-21T17:52:10.831679+00:00`  
...
```bash
python3 tests/eval_natural_language_product_search_mvp/run_eval.py --port 32957 --runtime-env local
```
...
| **Failed Cases** | `2` |
| **Pass Rate** | **60.0%** |
| **Faithfulness Rate (`return_products`)** | `0.875` |
| **Avg Recall (`return_products`)** | `0.917` |
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `TC-01` | `vietnamese_nlp` | *"có những loại kính thiên văn nào?"* | `0PUK6V6EV0, 1YMWWN1N4O, 66VCHSJNUP, 6E92ZMYYFZ, 9SIQT8TOJO, OLJCESPC7Z` | `0PUK6V6EV0, 1YMWWN1N4O, 66VCHSJNUP, 6E92ZMYYFZ, OLJCESPC7Z` | `False` | 1.00 | 0.83 | `1610` | `64` | `$0.000643` | **❌ FAIL** |
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `1605` | `64` | `$0.000642` | **✅ PASS** |
| `TC-03` | `vietnamese_nlp` | *"có kính thiên văn nào rẻ rẻ không?"* | `0PUK6V6EV0, 1YMWWN1N4O, 66VCHSJNUP, 6E92ZMYYFZ, 9SIQT8TOJO, OLJCESPC7Z` | `6E92ZMYYFZ, OLJCESPC7Z, 1YMWWN1N4O, 0PUK6V6EV0, 66VCHSJNUP` | `False` | 1.00 | 0.83 | `1611` | `66` | `$0.000648` | **❌ FAIL** |
