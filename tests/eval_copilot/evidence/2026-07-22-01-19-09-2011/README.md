# Evaluation Run Evidence — `2026-07-22-01-19-09-2011`

> **Timestamp (UTC)**: `2026-07-21T18:19:09.201061+00:00`  
...
- **Dataset SHA-256**: `73953734ec864d25d00877fbf8775fb12ef9933d9622c5b854859f40c65fbd21`
...
```bash
python3 tests/eval_natural_language_product_search_mvp/run_eval.py --port 32964 --runtime-env local
```
...
| **Failed Cases** | `1` |
| **Pass Rate** | **90.0%** |
| **Faithfulness Rate (`return_products`)** | `0.786` |
| **Avg Recall (`return_products`)** | `0.857` |
| **Total Input Tokens** | `18,574` |
| **Total Output Tokens** | `921` |
| **Total Estimated Cost (USD)** | `$0.007875` |
...
| `TC-03` | `vietnamese_nlp` | *"có kính thiên văn nào rẻ rẻ không?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `1860` | `106` | `$0.000823` | **✅ PASS** |
| `TC-04` | `vietnamese_nlp` | *"màn lọc kính thiên văn"* | `6E92ZMYYFZ` | `0PUK6V6EV0, 6E92ZMYYFZ` | `False` | 0.50 | 1.00 | `1857` | `85` | `$0.000770` | **✅ PASS** |
| `TC-05` | `vietnamese_nlp` | *"chòa bạn"* | `[]` | `[]` | `True` | — | — | `1854` | `53` | `$0.000689` | **✅ PASS** |
| `TC-06` | `vietnamese_nlp` | *"tôi muốn mua kính thiên văn rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `1860` | `91` | `$0.000785` | **✅ PASS** |
| `TC-07` | `vietnamese_nlp` | *"hi"* | `[]` | `[]` | `True` | — | — | `1852` | `53` | `$0.000688` | **✅ PASS** |
| `TC-08` | `vietnamese_nlp` | *"có truyện tranh không?"* | `HQTGWGPNH4` | `HQTGWGPNH4` | `False` | 1.00 | 1.00 | `1857` | `77` | `$0.000750` | **✅ PASS** |
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `1860` | `175` | `$0.000996` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `[]` | `True` | — | — | `1861` | `107` | `$0.000826` | **❌ FAIL** |
