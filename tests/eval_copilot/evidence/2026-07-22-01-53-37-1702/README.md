# Evaluation Run Evidence — `2026-07-22-01-53-37-1702`

> **Timestamp (UTC)**: `2026-07-21T18:53:37.170163+00:00`  
...
| **Failed Cases** | `3` |
| **Pass Rate** | **75.0%** |
| **Faithfulness Rate (`return_products`)** | `0.611` |
| **Avg Recall (`return_products`)** | `0.667` |
| **Total Input Tokens** | `16,333` |
| **Total Output Tokens** | `667` |
| **Total Estimated Cost (USD)** | `$0.006567` |
...
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `2039` | `85` | `$0.000824` | **✅ PASS** |
| `TC-03` | `vietnamese_nlp` | *"có kính thiên văn nào rẻ rẻ không?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2045` | `108` | `$0.000883` | **✅ PASS** |
...
| `TC-06` | `vietnamese_nlp` | *"tôi muốn mua kính thiên văn rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2045` | `106` | `$0.000879` | **✅ PASS** |
