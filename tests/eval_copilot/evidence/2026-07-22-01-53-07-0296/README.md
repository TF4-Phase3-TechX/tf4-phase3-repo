# Evaluation Run Evidence — `2026-07-22-01-53-07-0296`

> **Timestamp (UTC)**: `2026-07-21T18:53:07.029601+00:00`  
...
| **Failed Cases** | `2` |
| **Pass Rate** | **83.3%** |
| **Faithfulness Rate (`return_products`)** | `0.722` |
| **Avg Recall (`return_products`)** | `0.778` |
| **Total Input Tokens** | `17,460` |
| **Total Output Tokens** | `685` |
| **Total Estimated Cost (USD)** | `$0.006950` |
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `TC-01` | `vietnamese_nlp` | *"có những loại kính thiên văn nào?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `1YMWWN1N4O, 66VCHSJNUP, OLJCESPC7Z` | `False` | 1.00 | 1.00 | `2250` | `92` | `$0.000905` | **✅ PASS** |
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `2130` | `74` | `$0.000824` | **✅ PASS** |
| `TC-03` | `vietnamese_nlp` | *"có kính thiên văn nào rẻ rẻ không?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2256` | `122` | `$0.000982` | **✅ PASS** |
| `TC-04` | `vietnamese_nlp` | *"màn lọc kính thiên văn"* | `6E92ZMYYFZ` | `0PUK6V6EV0, 6E92ZMYYFZ` | `False` | 0.50 | 1.00 | `2173` | `79` | `$0.000849` | **✅ PASS** |
| `TC-05` | `vietnamese_nlp` | *"chòa bạn"* | `[]` | `[]` | `True` | — | — | `2039` | `53` | `$0.000744` | **✅ PASS** |
| `TC-06` | `vietnamese_nlp` | *"tôi muốn mua kính thiên văn rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `[]` | `True` | — | — | `0` | `0` | `$0.000000` | **❌ FAIL** |
| `TC-07` | `vietnamese_nlp` | *"hi"* | `[]` | `[]` | `True` | — | — | `0` | `0` | `$0.000000` | **✅ PASS** |
| `TC-08` | `vietnamese_nlp` | *"có truyện tranh không?"* | `HQTGWGPNH4` | `HQTGWGPNH4` | `False` | 1.00 | 1.00 | `2148` | `87` | `$0.000862` | **✅ PASS** |
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `0` | `0` | `$0.000000` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp_multiturn` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `66VCHSJNUP` | `False` | 1.00 | 1.00 | `2230` | `83` | `$0.000877` | **✅ PASS** |
| `TC-11` | `vietnamese_nlp_multiturn` | *"đánh giá như thế nào?"* | `2ZYFJ3GM2N` | `[]` | `True` | — | — | `0` | `0` | `$0.000000` | **❌ FAIL** |
| `TC-12` | `vietnamese_nlp_multiturn` | *"cái nào rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2234` | `95` | `$0.000908` | **✅ PASS** |
