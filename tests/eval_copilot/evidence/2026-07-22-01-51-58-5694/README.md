# Evaluation Run Evidence — `2026-07-22-01-51-58-5694`

> **Timestamp (UTC)**: `2026-07-21T18:51:58.569458+00:00`  
...
| **Total Input Tokens** | `24,773` |
| **Total Output Tokens** | `1,280` |
| **Total Estimated Cost (USD)** | `$0.010632` |
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `TC-01` | `vietnamese_nlp` | *"có những loại kính thiên văn nào?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `1YMWWN1N4O, 66VCHSJNUP, OLJCESPC7Z` | `False` | 1.00 | 1.00 | `2125` | `94` | `$0.000873` | **✅ PASS** |
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `2074` | `90` | `$0.000847` | **✅ PASS** |
| `TC-03` | `vietnamese_nlp` | *"có kính thiên văn nào rẻ rẻ không?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2128` | `103` | `$0.000896` | **✅ PASS** |
| `TC-04` | `vietnamese_nlp` | *"màn lọc kính thiên văn"* | `6E92ZMYYFZ` | `0PUK6V6EV0, 6E92ZMYYFZ` | `False` | 0.50 | 1.00 | `2093` | `101` | `$0.000880` | **✅ PASS** |
| `TC-05` | `vietnamese_nlp` | *"chòa bạn"* | `[]` | `[]` | `True` | — | — | `2039` | `53` | `$0.000744` | **✅ PASS** |
| `TC-06` | `vietnamese_nlp` | *"tôi muốn mua kính thiên văn rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2128` | `132` | `$0.000968` | **✅ PASS** |
| `TC-07` | `vietnamese_nlp` | *"hi"* | `[]` | `[]` | `True` | — | — | `2037` | `53` | `$0.000744` | **✅ PASS** |
| `TC-08` | `vietnamese_nlp` | *"có truyện tranh không?"* | `HQTGWGPNH4` | `HQTGWGPNH4` | `False` | 1.00 | 1.00 | `2083` | `100` | `$0.000875` | **✅ PASS** |
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `2102` | `82` | `$0.000836` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp_multiturn` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `66VCHSJNUP` | `False` | 1.00 | 1.00 | `2235` | `83` | `$0.000878` | **✅ PASS** |
| `TC-11` | `vietnamese_nlp_multiturn` | *"đánh giá như thế nào?"* | `2ZYFJ3GM2N` | `2ZYFJ3GM2N` | `False` | 1.00 | 1.00 | `3729` | `389` | `$0.002091` | **✅ PASS** |
| `TC-12` | `vietnamese_nlp_multiturn` | *"cái nào rẻ nhất"* | `1YMWWN1N4O` | `[]` | `True` | — | — | `0` | `0` | `$0.000000` | **❌ FAIL** |
