# Evaluation Run Evidence — `2026-07-22-01-36-46-5900`

> **Timestamp (UTC)**: `2026-07-21T18:36:46.589920+00:00`  
...
| **Total Estimated Cost (USD)** | `$0.010456` |
...
| `TC-08` | `vietnamese_nlp` | *"có truyện tranh không?"* | `HQTGWGPNH4` | `HQTGWGPNH4` | `False` | 1.00 | 1.00 | `1992` | `89` | `$0.000820` | **✅ PASS** |
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `1995` | `174` | `$0.001033` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `66VCHSJNUP` | `False` | 1.00 | 1.00 | `2032` | `102` | `$0.000865` | **✅ PASS** |
| `TC-11` | `vietnamese_nlp` | *"đánh giá như thế nào?"* | `1YMWWN1N4O` | `2ZYFJ3GM2N` | `False` | 0.00 | 0.00 | `3445` | `415` | `$0.002071` | **❌ FAIL** |
