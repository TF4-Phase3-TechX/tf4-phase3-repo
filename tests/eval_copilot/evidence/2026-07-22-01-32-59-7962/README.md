# Evaluation Run Evidence — `2026-07-22-01-32-59-7962`

> **Timestamp (UTC)**: `2026-07-21T18:32:59.796182+00:00`  
...
| **Total Input Tokens** | `19,960` |
| **Total Output Tokens** | `949` |
| **Total Estimated Cost (USD)** | `$0.008360` |
...
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `1989` | `80` | `$0.000797` | **✅ PASS** |
...
| `TC-08` | `vietnamese_nlp` | *"có truyện tranh không?"* | `HQTGWGPNH4` | `HQTGWGPNH4` | `False` | 1.00 | 1.00 | `1992` | `87` | `$0.000815` | **✅ PASS** |
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `1995` | `168` | `$0.001019` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `66VCHSJNUP` | `False` | 1.00 | 1.00 | `2032` | `104` | `$0.000870` | **✅ PASS** |
