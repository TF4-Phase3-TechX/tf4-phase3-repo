# Evaluation Run Evidence — `2026-07-22-01-56-18-3609`

> **Timestamp (UTC)**: `2026-07-21T18:56:18.360917+00:00`  
...
| **Avg Recall (`return_products`)** | `0.926` |
| **Total Input Tokens** | `26,148` |
| **Total Output Tokens** | `1,460` |
| **Total Estimated Cost (USD)** | `$0.011494` |
...
| :--- | :--- | :--- | :--- | :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
| `TC-01` | `vietnamese_nlp` | *"có những loại kính thiên văn nào?"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `1YMWWN1N4O, 66VCHSJNUP, OLJCESPC7Z` | `False` | 1.00 | 1.00 | `2044` | `127` | `$0.000931` | **✅ PASS** |
...
| `TC-06` | `vietnamese_nlp` | *"tôi muốn mua kính thiên văn rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `False` | 1.00 | 1.00 | `2045` | `104` | `$0.000874` | **✅ PASS** |
...
| `TC-12` | `vietnamese_nlp_multiturn` | *"cái nào rẻ nhất"* | `OLJCESPC7Z, 1YMWWN1N4O, 66VCHSJNUP` | `1YMWWN1N4O` | `False` | 1.00 | 0.33 | `2124` | `115` | `$0.000925` | **❌ FAIL** |
