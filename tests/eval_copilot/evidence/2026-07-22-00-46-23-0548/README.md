# Evaluation Run Evidence — `2026-07-22-00-46-23-0548`

> **Timestamp (UTC)**: `2026-07-21T17:46:23.054591+00:00`  
...
| **Total Input Tokens** | `43,511` |
| **Total Output Tokens** | `1,265` |
| **Total Estimated Cost (USD)** | `$0.016216` |
...
| `TC-39` | `multilingual_search` | *"sản phẩm dưới 100 đô"* | `6E92ZMYYFZ, HQTGWGPNH4, L9ECAV7KIM, LS4PSXUNUM` | `[]` | `True` | — | — | `1609` | `78` | `$0.000678` | **❌ FAIL** |
