# Evaluation Run Evidence — `2026-07-22-01-34-29-9908`

> **Timestamp (UTC)**: `2026-07-21T18:34:29.990789+00:00`  
...
```bash
python3 tests/eval_natural_language_product_search_mvp/run_eval.py --port 32968 --runtime-env local
```
...
| **Failed Cases** | `1` |
| **Pass Rate** | **90.9%** |
| **Faithfulness Rate (`return_products`)** | `0.812` |
| **Avg Recall (`return_products`)** | `0.875` |
| **Total Input Tokens** | `23,405` |
| **Total Output Tokens** | `1,365` |
| **Total Estimated Cost (USD)** | `$0.010434` |
...
| `TC-02` | `vietnamese_nlp` | *"đèn pin"* | `LS4PSXUNUM` | `LS4PSXUNUM` | `False` | 1.00 | 1.00 | `1989` | `97` | `$0.000839` | **✅ PASS** |
...
| `TC-09` | `vietnamese_nlp` | *"tôi muốn mua 1 bộ one piece"* | `[]` | `[]` | `True` | — | — | `1995` | `169` | `$0.001021` | **✅ PASS** |
| `TC-10` | `vietnamese_nlp` | *"thêm cái đắt nhất vào giỏ hàng"* | `66VCHSJNUP` | `66VCHSJNUP` | `False` | 1.00 | 1.00 | `2032` | `102` | `$0.000865` | **✅ PASS** |
| `TC-11` | `vietnamese_nlp` | *"đánh giá như thế nào?"* | `1YMWWN1N4O` | `2ZYFJ3GM2N` | `False` | 0.00 | 0.00 | `3445` | `411` | `$0.002061` | **❌ FAIL** |
