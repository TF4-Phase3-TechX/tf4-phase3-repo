...
public class ValkeyCartStore : ICartStore
{
    ...
    // enableTls/password default to the previous plaintext, no-auth behavior (in-cluster Valkey).
    // Ref: CDO08-REL-16 - ElastiCache cutover requires ssl=true plus an AUTH token.
