...
function createBaseCartActionProposal(): CartActionProposal {
  return {
    actionType: "",
    productId: "",
    productName: "",
...
export const CartActionProposal: MessageFns<CartActionProposal> = {
  encode(message: CartActionProposal, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.confirmationRequired !== false) {
      writer.uint32(40).bool(message.confirmationRequired);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CartActionProposal {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseCartActionProposal();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): CartActionProposal {
    return {
      ...
      quantity: isSet(object.quantity) ? globalThis.Number(object.quantity) : 0,
      confirmationRequired: isSet(object.confirmationRequired)
        ? globalThis.Boolean(object.confirmationRequired)
        : false,
      idempotencyKey: isSet(object.idempotencyKey) ? globalThis.String(object.idempotencyKey) : "",
    };
  },

  toJSON(message: CartActionProposal): unknown {
    const obj: any = {};
    if (message.actionType !== "") {
    ...
    if (message.confirmationRequired !== false) {
      obj.confirmationRequired = message.confirmationRequired;
    }
    if (message.idempotencyKey !== "") {
  ...
  create<I extends Exact<DeepPartial<CartActionProposal>, I>>(base?: I): CartActionProposal {
    return CartActionProposal.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<CartActionProposal>, I>>(object: I): CartActionProposal {
    const message = createBaseCartActionProposal();
    message.actionType = object.actionType ?? "";
    message.productId = object.productId ?? "";
    message.productName = object.productName ?? "";
    message.quantity = object.quantity ?? 0;
    message.confirmationRequired = object.confirmationRequired ?? false;
...
function createBaseAskProductAIAssistantRequest(): AskProductAIAssistantRequest {
  return { productId: "", question: "", sessionId: "", userId: "" };
}
...
export const SearchProductsAIAssistantRequest: MessageFns<SearchProductsAIAssistantRequest> = {
  ...
  create<I extends Exact<DeepPartial<SearchProductsAIAssistantRequest>, I>>(
    base?: I,
  ): SearchProductsAIAssistantRequest {
    return SearchProductsAIAssistantRequest.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SearchProductsAIAssistantRequest>, I>>(
    object: I,
  ): SearchProductsAIAssistantRequest {
    const message = createBaseSearchProductsAIAssistantRequest();
    message.query = object.query ?? "";
...
export const SearchProductsAIAssistantResponse: MessageFns<SearchProductsAIAssistantResponse> = {
  encode(message: SearchProductsAIAssistantResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.trace !== undefined) {
      SearchEvidenceTrace.encode(message.trace, writer.uint32(18).fork()).join();
    }
    if (message.actionProposal !== undefined) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.trace = SearchEvidenceTrace.decode(reader, reader.uint32());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  toJSON(message: SearchProductsAIAssistantResponse): unknown {
    ...
    if (message.trace !== undefined) {
      obj.trace = SearchEvidenceTrace.toJSON(message.trace);
    }
    if (message.actionProposal !== undefined) {
      obj.actionProposal = CartActionProposal.toJSON(message.actionProposal);
    }
  ...
  create<I extends Exact<DeepPartial<SearchProductsAIAssistantResponse>, I>>(
    base?: I,
  ): SearchProductsAIAssistantResponse {
    return SearchProductsAIAssistantResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SearchProductsAIAssistantResponse>, I>>(
    object: I,
  ): SearchProductsAIAssistantResponse {
    const message = createBaseSearchProductsAIAssistantResponse();
    message.results = object.results?.map((e) => Product.fromPartial(e)) || [];
    message.trace = (object.trace !== undefined && object.trace !== null)
      ? SearchEvidenceTrace.fromPartial(object.trace)
      : undefined;
    message.actionProposal = (object.actionProposal !== undefined && object.actionProposal !== null)
      ? CartActionProposal.fromPartial(object.actionProposal)
      : undefined;
...
function createBaseSearchEvidenceTrace(): SearchEvidenceTrace {
  return {
    parsedIntent: "",
    filterApplied: "",
...
export const SearchEvidenceTrace: MessageFns<SearchEvidenceTrace> = {
  encode(message: SearchEvidenceTrace, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.parsedIntent !== "") {
      writer.uint32(10).string(message.parsedIntent);
    }
    if (message.filterApplied !== "") {
      writer.uint32(18).string(message.filterApplied);
    }
    if (message.candidateCountBefore !== 0) {
      writer.uint32(24).int32(message.candidateCountBefore);
    }
    if (message.candidateCountAfter !== 0) {
      writer.uint32(32).int32(message.candidateCountAfter);
    }
    if (message.refused !== false) {
      writer.uint32(40).bool(message.refused);
    }
    if (message.inputTokens !== 0) {
      writer.uint32(48).int32(message.inputTokens);
    }
    if (message.outputTokens !== 0) {
      writer.uint32(56).int32(message.outputTokens);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SearchEvidenceTrace {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseSearchEvidenceTrace();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
          ...
          message.parsedIntent = reader.string();
          continue;
        }
        case 2: {
          if (tag !== 18) {
          ...
          message.filterApplied = reader.string();
          continue;
        }
        case 3: {
          if (tag !== 24) {
          ...
          message.candidateCountBefore = reader.int32();
          continue;
        }
        case 4: {
          if (tag !== 32) {
          ...
          message.candidateCountAfter = reader.int32();
          continue;
        }
        case 5: {
          if (tag !== 40) {
  ...
  fromJSON(object: any): SearchEvidenceTrace {
    return {
      parsedIntent: isSet(object.parsedIntent) ? globalThis.String(object.parsedIntent) : "",
      filterApplied: isSet(object.filterApplied) ? globalThis.String(object.filterApplied) : "",
      candidateCountBefore: isSet(object.candidateCountBefore) ? globalThis.Number(object.candidateCountBefore) : 0,
      candidateCountAfter: isSet(object.candidateCountAfter) ? globalThis.Number(object.candidateCountAfter) : 0,
      refused: isSet(object.refused) ? globalThis.Boolean(object.refused) : false,
  ...
  toJSON(message: SearchEvidenceTrace): unknown {
    const obj: any = {};
    if (message.parsedIntent !== "") {
      obj.parsedIntent = message.parsedIntent;
    }
    if (message.filterApplied !== "") {
      obj.filterApplied = message.filterApplied;
    }
    if (message.candidateCountBefore !== 0) {
      obj.candidateCountBefore = Math.round(message.candidateCountBefore);
    }
    if (message.candidateCountAfter !== 0) {
      obj.candidateCountAfter = Math.round(message.candidateCountAfter);
    }
    if (message.refused !== false) {
  ...
  create<I extends Exact<DeepPartial<SearchEvidenceTrace>, I>>(base?: I): SearchEvidenceTrace {
    return SearchEvidenceTrace.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SearchEvidenceTrace>, I>>(object: I): SearchEvidenceTrace {
    const message = createBaseSearchEvidenceTrace();
    message.parsedIntent = object.parsedIntent ?? "";
    message.filterApplied = object.filterApplied ?? "";
    message.candidateCountBefore = object.candidateCountBefore ?? 0;
    message.candidateCountAfter = object.candidateCountAfter ?? 0;
    message.refused = object.refused ?? false;
...
function createBaseConfirmCartActionRequest(): ConfirmCartActionRequest {
  return { userId: "", sessionId: "", confirmationToken: "" };
}
...
export const ConfirmCartActionRequest: MessageFns<ConfirmCartActionRequest> = {
  encode(message: ConfirmCartActionRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.confirmationToken !== "") {
      writer.uint32(26).string(message.confirmationToken);
    }
    return writer;
  },
...
export const BatchCurrencyConversionRequest: MessageFns<BatchCurrencyConversionRequest> = {
  ...
  fromJSON(object: any): BatchCurrencyConversionRequest {
    return {
      from: globalThis.Array.isArray(object?.from) ? object.from.map((e: any) => Money.fromJSON(e)) : [],
      toCode: isSet(object.toCode) ? globalThis.String(object.toCode) : "",
    };
  },
  ...
  toJSON(message: BatchCurrencyConversionRequest): unknown {
    ...
    if (message.from?.length) {
      obj.from = message.from.map((e) => Money.toJSON(e));
    }
    if (message.toCode !== "") {
      obj.toCode = message.toCode;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<BatchCurrencyConversionRequest>, I>>(
    ...
    const message = createBaseBatchCurrencyConversionRequest();
    message.from = object.from?.map((e) => Money.fromPartial(e)) || [];
    message.toCode = object.toCode ?? "";
    return message;
  },
};
...
function createBaseProductDisplay(): ProductDisplay {
  return { name: "", picture: "", categories: [] };
}

export const ProductDisplay: MessageFns<ProductDisplay> = {
  encode(message: ProductDisplay, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ProductDisplay {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseProductDisplay();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1: {
  ...
  fromJSON(object: any): ProductDisplay {
    return {
      name: isSet(object.name) ? globalThis.String(object.name) : "",
      picture: isSet(object.picture) ? globalThis.String(object.picture) : "",
      categories: globalThis.Array.isArray(object?.categories)
  ...
  toJSON(message: ProductDisplay): unknown {
    const obj: any = {};
    if (message.name !== "") {
      obj.name = message.name;
    }
  ...
  create<I extends Exact<DeepPartial<ProductDisplay>, I>>(base?: I): ProductDisplay {
    return ProductDisplay.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<ProductDisplay>, I>>(object: I): ProductDisplay {
    const message = createBaseProductDisplay();
    message.name = object.name ?? "";
    message.picture = object.picture ?? "";
    message.categories = object.categories?.map((e) => e) || [];
...
function createBaseOrderItem(): OrderItem {
  return { item: undefined, cost: undefined, productDisplay: undefined };
}
...
export const OrderItem: MessageFns<OrderItem> = {
  encode(message: OrderItem, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.productDisplay !== undefined) {
      ProductDisplay.encode(message.productDisplay, writer.uint32(26).fork()).join();
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3: {
          ...
          message.productDisplay = ProductDisplay.decode(reader, reader.uint32());
          continue;
        }
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): OrderItem {
    return {
      ...
      productDisplay: isSet(object.productDisplay) ? ProductDisplay.fromJSON(object.productDisplay) : undefined,
    };
  },
  ...
  toJSON(message: OrderItem): unknown {
    ...
    if (message.productDisplay !== undefined) {
      obj.productDisplay = ProductDisplay.toJSON(message.productDisplay);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<OrderItem>, I>>(object: I): OrderItem {
    ...
    message.productDisplay = (object.productDisplay !== undefined && object.productDisplay !== null)
      ? ProductDisplay.fromPartial(object.productDisplay)
      : undefined;
    return message;
  },
};
...
export const ProductReviewServiceService = {
  ...
  searchProductsAiAssistant: {
    ...
    requestDeserialize: (value: Buffer): SearchProductsAIAssistantRequest =>
      SearchProductsAIAssistantRequest.decode(value),
    ...
    responseDeserialize: (value: Buffer): SearchProductsAIAssistantResponse =>
      SearchProductsAIAssistantResponse.decode(value),
  },
  confirmCartAction: {
    path: "/oteldemo.ProductReviewService/ConfirmCartAction",
    requestStream: false,
    responseStream: false,
...
export interface ProductReviewServiceServer extends UntypedServiceImplementation {
  ...
  searchProductsAiAssistant: handleUnaryCall<SearchProductsAIAssistantRequest, SearchProductsAIAssistantResponse>;
  confirmCartAction: handleUnaryCall<ConfirmCartActionRequest, ConfirmCartActionResponse>;
}
...
export const CurrencyServiceService = {
  ...
  batchConvert: {
    ...
    responseDeserialize: (value: Buffer): BatchCurrencyConversionResponse =>
      BatchCurrencyConversionResponse.decode(value),
  },
} as const;
