...
# ─────────────────────────────────────────────────────────────
# 9. IAM Customer Managed Policy Attachment cho Audit Analyst SSO Permission Set (CDO-07)
# ─────────────────────────────────────────────────────────────
resource "aws_ssoadmin_customer_managed_policy_attachment" "audit_analyst_athena_forensics" {
  instance_arn       = "arn:aws:sso:::instance/ssoins-722318e52a41ca7c"
  permission_set_arn = "arn:aws:sso:::permissionSet/ssoins-722318e52a41ca7c/ps-722345051d003de6"

  customer_managed_policy_reference {
    name = aws_iam_policy.athena_audit_analyst.name
  }
}

resource "aws_ssoadmin_customer_managed_policy_attachment" "audit_analyst_cw_insights" {
  instance_arn       = "arn:aws:sso:::instance/ssoins-722318e52a41ca7c"
  permission_set_arn = "arn:aws:sso:::permissionSet/ssoins-722318e52a41ca7c/ps-722345051d003de6"

  customer_managed_policy_reference {
    name = aws_iam_policy.cloudwatch_insights_forensics.name
  }
}
